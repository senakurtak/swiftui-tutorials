...
struct Template1Sample: View {
    var body: some View {
        ...
        VStack{
            ...
            .foregroundColor(Color(red:0.92, green: 0.46, blue: 0.38))
            .cornerRadius(25)
            ...
            .foregroundColor(Color(red:0.55, green: 0.75, blue: 0.72))
            .cornerRadius(25)
            ...
            .foregroundColor(Color(red:0.93, green: 0.58, blue: 0.17))
            .cornerRadius(25)
            ...
            .foregroundColor(Color(red:0.13, green: 0.40, blue: 0.60))
            .cornerRadius(25)
            
            Spacer()
            // göbekten başlamasın, üstten başlasın diye ekliyoruz. Swift ortadan başlama eğilimindedir.
        } .padding()
    }
}
